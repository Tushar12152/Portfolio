...
//     return (
//         <div className=" bg-black bg-[https://i.ibb.co/41HPDKr/2abmyc6.jpg] bg-cover bg-center h-screen flex items-center justify-center" >
//                <Container>
...
const Banner = () => {
    return (
        <div className="bg-cover bg-center h-screen flex items-center justify-center bg-black" style={{backgroundImage: "url('https://i.ibb.co/2MGY9wr/photo-1502239608882-93b729c6af43.jpg')", opacity:""}}>
            <Container>
                <div className="flex flex-col lg:flex-row items-center justify-between">
                    <div className="text-white lg:w-[50%]">
                        {/* left side text */}
